...
namespace Idle
{
    public class CompanyAcquisitionUpgrade : Upgrade
    {
        ...
        public override void UpgradeItem(int id)
        {
            ...
            DataManager.upgradeData.companyAcquisitionLvl++; //Increases level +1
        ...
        void UpdateObjects()
        {
            ...
            for (int i = 0; i < DataManager.upgradeData.companyAcquisitionLvl; i++)
            {
